    ...
    return (
      <div className="w-full max-w-[100vw] mx-auto px-0">
        ...
        >
          <CarouselContent className="-ml-4">
            {programs.map((program) => {
              ...
              return (
                <CarouselItem
                  key={program.id}
                  className="pl-4 basis-[80%] md:basis-[75%] first:pl-0"
                >
          ...
          <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-white/95 via-white/50 to-transparent pointer-events-none z-10" />
          <div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-white/95 via-white/50 to-transparent pointer-events-none z-10" />
